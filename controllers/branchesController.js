...
// Función para obtener el conjunto de clientes de una sucursal 
exports.getClientBySucursal = async (req, res) => {
    const { sucursalId } = req.params;
    try {
      const clientes = await redisClient.smembers(`sucursal:${sucursalId}:clientes`);
      res.json(clientes);
    } catch (error) {
